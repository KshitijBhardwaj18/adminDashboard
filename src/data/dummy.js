...
export const EditorData = () => (
  <div>
    <h3>
      Whatsuppp potential Client, Greetings! I hope this message finds you well.
      My name is Kshitij Bhardwaj, and I am a passionate and skilled Full Stack
      Developer eager to bring my expertise and dedication to your esteemed
      team. I am thrilled at the opportunity to be considered for a role within
      your organization, where I can contribute my technical prowess and
      problem-solving abilities to create innovative and user-friendly web
      applications. As a Full Stack Developer, I possess a comprehensive
      understanding of both front-end and back-end technologies, allowing me to
      deliver end-to-end solutions that meet and exceed the expectations of
      clients and users alike. My journey in web development began with an
      insatiable curiosity that led me to explore various programming languages,
      frameworks, and tools, eventually refining my proficiency across the
      entire development stack. On the front-end, I am well-versed in HTML, CSS,
      and JavaScript, ensuring that I can craft visually appealing and highly
      responsive user interfaces. Additionally, I have expertise in popular
      front-end frameworks such as React and Angular, enabling me to build
      interactive and dynamic web applications that deliver a seamless user
      experience. At the back-end, I have honed my skills in programming
      languages like Python and Node.js, giving me the ability to design robust
      and scalable server-side logic. Furthermore, I am experienced in working
      with databases such as MySQL, MongoDB, and PostgreSQL, effectively
      managing data and ensuring its integrity throughout the application
      lifecycle. What sets me apart as a Full Stack Developer is not only my
      technical proficiency but also my commitment to staying updated with the
      latest industry trends and best practices. I thrive in collaborative
      environments and have successfully collaborated with cross-functional
      teams to deliver projects within deadlines while maintaining the highest
      standard of code quality. I believe that innovation stems from the
      seamless integration of technology and creativity, and I am eager to
      leverage my skills to contribute to the success of your organization. I am
      excited about the possibility of joining your team and contributing my
      expertise to drive meaningful impact in the digital landscape. Thank you
      for considering my application. I am looking forward to the opportunity to
      discuss how I can contribute to your team's success further. Sincerely,
      Kshitij Bhardwaj
    </h3>
  </div>
);
